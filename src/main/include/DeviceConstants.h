...
namespace pidf {
    ...
    constexpr double kClimberP = 3.0;
    constexpr double kClimberI = 0.0;
    constexpr double kClimberD = 0.1;

    constexpr double kClimberS = 2.0;
    constexpr double kClimberV = 38.5;
    constexpr double kClimberA = 4.0;
}
