...
void ProfiledDriveToPose::Init() {
  ...
  DataLogger::Log( "Profiled Drive/xGoal",m_xGoal.position.value() );
  DataLogger::Log( "Profiled Drive/yGoal",m_yGoal.position.value() );
  DataLogger::Log( "Profiled Drive/omegaGoal",m_omegaGoal.position.value() );
...
void ProfiledDriveToPose::Execute() {
  ...
  DataLogger::Log( "Profiled Drive/Pose",m_swerve->GetPose() );
