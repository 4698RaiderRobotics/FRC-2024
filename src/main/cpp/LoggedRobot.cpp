...
void LoggedRobot::RobotPeriodic() {
    ...
    frc::CANStatus cs;
     ...
     DataLogger::Log( "RoboRIO/3V3 Fault Count", frc::RobotController::GetFaultCount3V3() );
     ...
     DataLogger::Log( "RoboRIO/5V Fault Count", frc::RobotController::GetFaultCount5V() );
    ...
    cs = frc::RobotController::GetCANStatus();
     ...
     DataLogger::Log( "RoboRIO/CAN OffCount", cs.busOffCount );
     DataLogger::Log( "RoboRIO/CAN receiveErrorCount", cs.receiveErrorCount );
     DataLogger::Log( "RoboRIO/CAN transmitErrorCount", cs.transmitErrorCount );
     DataLogger::Log( "RoboRIO/CAN txFullCount", cs.txFullCount );
